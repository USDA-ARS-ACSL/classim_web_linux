    ...
    try:
        ...
        # cotton
            ...
            if crop == "maize":
                ...
                fout.write(f'{hybridparameters[14]:-14.6f}{hybridparameters[15]:-14.6f}{hybridparameters[16]:-14.6f}\n')
                ...
                fout.write(f'{hybridparameters[20]:-14.6f}{hybridparameters[21]:-14.6f}\n')
                ...
                fout.write("*** ROOT MOVER PARAMETER INFORMATION **************************\n")
                fout.write("EPSI        lUpW             CourMax\n")
                fout.write(f'{hybridparameters[16]:-14.6f}{hybridparameters[17]:-14.6f}{hybridparameters[18]:-14.6f}\n')
                fout.write("Diffusivity and geotropic velocity\n")
                fout.write(f'{hybridparameters[19]:-14.6f}{hybridparameters[20]:-14.6f}{hybridparameters[21]:-14.6f}\n')
                fout.write("[SoilNitrogen]\n")
                fout.write("*** NITROGEN ROOT UPTAKE PARAMETER INFORMATION **************************\n")
                fout.write("ISINK    Rroot         \n")
                fout.write(f'{hybridparameters[22]:-14.6f}{hybridparameters[23]:-14.6f}\n')
                fout.write("ConstI   Constk     Cmin0 \n")
                ...
                fout.write("*** ROOT MOVER PARAMETER INFORMATION **************************\n")
                fout.write("EPSI        lUpW             CourMax\n")
                fout.write(f'{hybridparameters[34]:-14.6f}{hybridparameters[35]:-14.6f}{hybridparameters[36]:-14.6f}\n')
                fout.write("Diffusivity and geotropic velocity\n")
                fout.write(f'{hybridparameters[37]:-14.6f}{hybridparameters[38]:-14.6f}{hybridparameters[39]:-14.6f}\n')
                fout.write("[SoilNitrogen]\n")
                fout.write("*** NITROGEN ROOT UPTAKE PARAMETER INFORMATION **************************\n")
                fout.write("ISINK    Rroot         \n")
                fout.write(f'{hybridparameters[40]:-14.6f}{hybridparameters[41]:-14.6f}\n')
                fout.write("ConstI   Constk     Cmin0 \n")
                ...
                fout.write("*** ROOT MOVER PARAMETER INFORMATION **************************\n")
                fout.write("EPSI        lUpW             CourMax\n")
                fout.write(f'{epsi:-14.6f}{iupw:-14.6f}{courmax:-14.6f}\n')
                fout.write("Diffusivity and geotropic velocity\n")
                fout.write(f'{diffx:-14.6f}{diffz:-14.6f}{velz:-14.6f}\n')
                fout.write("[SoilNitrogen]\n")
                fout.write("*** NITROGEN ROOT UPTAKE PARAMETER INFORMATION **************************\n")
                fout.write("ISINK    Rroot         \n")
                fout.write(f'{isink:-14.6f}{rroot:-14.6f}\n')
                fout.write("ConstI   Constk     Cmin0 \n")
...
def WriteWeather(current_user,experiment,treatmentname,stationtype,weather,field_path,tempVar,rainVar,CO2Var,session:SessionDep):
...
def WriteSoluteFile(soilname, field_path, session):
    ...
    try:
        with open(filename, 'w', encoding=CODEC) as fout:
            ...
            fout.write("EPSI        lUpW             CourMax\n")
            fout.write(f'{solute_tuple[1]:-14.6f}{solute_tuple[2]:-14.6f}{solute_tuple[3]:-14.6f}\n')
